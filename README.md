# Базовый курс веб-разработки [![Build Status](https://travis-ci.com/Maximumstart-basic-course/margarita-e1-005.svg?branch=master)](https://travis-ci.com/Maximumstart-basic-course/margarita-e1-005)

* Студент:  Барабаш Маргарита.
* Ментор: Князевич Павел.
